    ...
    typ match {
      ...
      case typeVariable: ResolvedTypeVariable =>
        ...
        if (substitutedTypeOpt.isDefined) {
          ...
          if (extendsBoundOption.isDefined
